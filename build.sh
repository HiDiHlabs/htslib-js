...
$CC $HEADERS $RELEASE_FLAGS pileup.cpp -o pileup.bc

$CC pileup.bc digenome.bc interface.bc hfile_js.bc hts_js.bc htslib/libhts.a zlib/libz.a $HEADERS --post-js <(echo "self['Module'] = Module; self['Pointer_stringify'] = Pointer_stringify;") -s EXPORTED_FUNCTIONS="['_bgzf_open_js', '_bgzf_close_js', '_run_digenome', '_run_pileup']" $RELEASE_FLAGS -o htslib_worker.js
