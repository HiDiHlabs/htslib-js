...
$CC interface.bc hfile_js.bc hts_js.bc htslib/libhts.a zlib/libz.a $HEADERS $POST_JS -s EXPORTED_FUNCTIONS="['_bgzf_open_js', '_sam_hdr_read_js', '_sam_read_1_js']" $RELEASE_FLAGS -o htslib_worker.js
