...
$CC interface_js.o digenome.o ../../libhts_js.a ../../htslib/libhts.a ../../zlib/libz.a $HEADERS --post-js post_combined.js -s EXPORTED_FUNCTIONS="['_hts_open_js', '_hts_close_js', '_run_digenome']" $RELEASE_FLAGS -o digenome.js
